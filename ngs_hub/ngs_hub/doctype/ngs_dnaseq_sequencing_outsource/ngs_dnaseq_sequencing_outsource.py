...
class NGSDNAseqSequencingOutsource(Document):
	def before_insert(self):
		if not self.customer:
			frappe.throw(_("Customer is required to generate DNAseq Sequencing Outsource"))
		if not self.project:
			frappe.throw(_("Project is required to generate DNAseq Sequencing Outsource"))
